...
*******************************************************************************/
static void ICACHE_FLASH_ATTR hw_timer_set_func_internal(void (* user_hw_timer_cb_set)(uint32_t), uint32_t arg)
{
   callback_arg = arg;
...
in non autoload mode:
                        10 ~ 0x7fffff;
*******************************************************************************/
static void  ICACHE_FLASH_ATTR  hw_timer_arm_internal(u32 val, bool reEnable)
{
   if (reEnable)
   {
...
static void ICACHE_FLASH_ATTR  hw_timer_disarm_internal()
{
   /* Set no reload mode */
...
void  ICACHE_FLASH_ATTR hw_timer_disarm()
{
...
bool  ICACHE_FLASH_ATTR hw_timer_arm(u32 val)
{
...
void  ICACHE_FLASH_ATTR hw_timer_set_func( void (* user_hw_timer_cb_set)(uint32_t), uint32_t arg )
{
...
static void  ICACHE_FLASH_ATTR  hw_test_timer_cb(uint32_t arg)
{
   // (void) arg;
   static uint32_t x = 0;
   static uint32 j = 0;
