	...
	switch (PIR_flags)
		{
			...
			case 0b00000001 :
			{	//	Зареєстровано рух, початок логічного циклу.
			...
			case 0b00000010 :
			{	//	Перша фаза, але рух припинився - скидання, повернення в 0
			...
			case 0b00000011 :
			{	//	Перша фаза, рух реєструється, -- таймера 1, перевірка таймера 1 == 0
			...
			case 0b00000100 :
			{	//	Друга фаза, але рух припинився, фіксуємо таймер 2, переход в фазу 3
			...
			case 0b00000101 :
			{	//	Друг фаза, рух є, ++ таймер 2, перевірка таймер 2 > таймер 2 макс.
			...
			case 0b00001000 :
			{	//	Третя фаза, руху нема -- таймер 2, перевірка таймер 2 == 0
			...
			case 0b00001001 :
			{	//	Третя фаза, знову рух, перехід у фазу 2
