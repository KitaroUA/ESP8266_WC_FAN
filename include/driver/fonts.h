 ...
 * fonts.h
 *
 *  Created on: 22 серп. 2017 р.
 *      Author: Kitaro
 */

#ifndef INCLUDE_DRIVER_FONTS_H_
#define INCLUDE_DRIVER_FONTS_H_
...
/* Шрифт 5х8
 * Таблица для отображения символов (ASCII[0x20-0x80] + CP1251[0xC0-0xFF] = всего 160 символов)
 */
char  Font5x8[][5] =
{
   ...
   { 0x00, 0x06, 0x09, 0x09, 0x06 },   // знак градусів 128
...
#define FONT5x8_NoBorder 0x00	//	Визначення для виростання заливки кольором фону, NoBorder - заливка робиться лише по елементу шрифта
#define FONT5x8_BorderRight 0x01	//	Заливати 1 піксель *розмір шрифта праворуч від шрифта
#define FONT5x8_BorderDown 0x10	//	Заливати 1 піксель *розмір шрифта нижче від шрифта
#define FONT5x8_BorderBoth 0x11




#endif /* INCLUDE_DRIVER_FONTS_H_ */
